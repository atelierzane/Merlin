...
namespace MerlinPointOfSale.Helpers
{
    class ApplicationHelper
    {
        ...
        {
            string path = @"C:\Users\zanef\source\repos\Merlin\MerlinPollingAgent\bin\Debug\net8.0-windows\MerlinPollingAgent.exe";
        ...
        {
            string path = @"C:\Users\zanef\source\repos\Merlin\MerlinBackOffice\bin\Debug\net8.0-windows\MerlinBackOffice.exe";
            return path;
        }
